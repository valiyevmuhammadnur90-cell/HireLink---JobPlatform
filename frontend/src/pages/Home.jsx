...
export default function Home() {
  ...
  useEffect(() => {
    api
      .get("/jobs?limit=6&sort=-createdAt")
      .then(({ data }) => {
    ...
    <div style={{ overflowX: "hidden" }}>
      ...
      >
        ...
        >
          ...
          {/* Heading */}
          <h1
            className="font-display text-4xl md:text-5xl font-semibold leading-tight max-w-2xl mx-auto"
            style={{
              opacity: heroVisible ? 1 : 0,
          ...
          >
            ...
            <span
              style={{
                background: "linear-gradient(90deg, #E0622B, #f5a06e)",
          ...
          {/* Subtext */}
          <p
            className="text-white/75 mt-5 max-w-lg mx-auto"
            style={{
              opacity: heroVisible ? 1 : 0,
              transform: heroVisible ? "translateY(0)" : "translateY(30px)",
          ...
          >
            Minglab kompaniyalar, real vaqtdagi vakansiyalar va bitta arizada
            ko'plab ishga murojaat qilish imkoniyati.
          </p>

          {/* Search */}
          <div
            className="mt-8 max-w-xl mx-auto bg-white rounded-lg p-1.5"
            style={{
              opacity: heroVisible ? 1 : 0,
          ...
          {[
            {
              icon: "🔍",
              title: "Aqlli qidiruv",
              desc: "Kalit so'zlar, maosh, joylashuv bo'yicha bir zumda filtrlang",
            },
            {
              icon: "📄",
              title: "Oson ariza",
              desc: "CV yuklang va bir marta bosish bilan ko'plab vakansiyalarga murojaat qiling",
            },
            {
              icon: "📊",
              title: "Real vaqt holati",
              desc: "Arizangizning holati yangilanganda darhol xabar oling",
            },
          ].map((f, i) => (
            <TiltCard key={f.title} className="card p-6">
              ...
              >
                ...
                <h3 className="font-display font-semibold mt-3 mb-1">
                  {f.title}
                </h3>

...
export default function JobCreateForm() {
  ...
  const inputCls =
    "w-full rounded-lg border border-line bg-surface px-4 py-3 text-sm placeholder:text-muted focus:border-primary outline-none transition-all duration-200 focus:shadow-[0_0_0_3px_rgba(14,92,79,0.12)]";
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background:
          "linear-gradient(135deg, #f6f5f1 0%, #e4f0ec 50%, #f6f5f1 100%)",
        padding: "40px 20px",
      }}
    >
      {/* Floating orbs */}
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <div
            style={{
              ...
              border: "1px solid rgba(14,92,79,0.2)",
              borderRadius: 999,
              padding: "6px 16px",
              marginBottom: 12,
            }}
              ...
              >
                <div
                  style={{
                    ...
                    borderRadius: "50%",
                    background:
                      i === step ? "#0E5C4F" : i < step ? "#E4F0EC" : "#fff",
                    border:
                      i === step
                        ? "2px solid #0E5C4F"
                        : i < step
                    ...
                    boxShadow:
                      i === step ? "0 4px 16px rgba(14,92,79,0.25)" : "none",
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Ish izlovchilar siz bilan to'g'ridan-to'g'ri bog'lana
                        oladi
                      </p>
                    </div>
                  </div>
                  ...
                  <div style={{ display: "flex", gap: 12 }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: loading
                          ? "#ccc"
                          : "linear-gradient(135deg, #E0622B, #C04F1F)",
                        color: "#fff",
                        border: "none",
                        borderRadius: 10,
                        padding: "14px 24px",
                        ...
                        boxShadow: loading
                          ? "none"
                          : "0 4px 16px rgba(224,98,43,0.35)",
                        transition: "all 0.2s ease",
                      }}
                    >

...
const jobSchema = new mongoose.Schema(
  ...
  contactPhone: String,
    ...
    title: { type: String, required: [true, 'Vakansiya nomi kiritilishi shart'], trim: true },
    description: { type: String, required: [true, 'Tavsif kiritilishi shart'] },
    company: { type: String, required: [true, 'Kompaniya nomi kiritilishi shart'] },
    location: { type: String, required: [true, 'Manzil kiritilishi shart'] },
    type: { type: String, enum: ['full-time', 'part-time', 'contract', 'internship', 'remote'], default: 'full-time' },
    category: { type: String, default: 'general' },
    salaryMin: { type: Number, default: 0 },
    salaryMax: { type: Number, default: 0 },
    currency: { type: String, default: 'USD' },
    experienceLevel: { type: String, enum: ['junior', 'middle', 'senior', 'lead', 'any'], default: 'any' },
    skills: [{ type: String }],
    requirements: [{ type: String }],
    benefits: [{ type: String }],
